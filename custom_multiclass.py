...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + 5 classes (rear bump, front bump, headlamp, door, hood)
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("part", 1, "dent")
        self.add_class("part", 2, "scratch")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        num_ids = np.asarray(info['num_ids'])
